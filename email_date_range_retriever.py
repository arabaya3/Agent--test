...
def search_emails_by_date_range(start_date, end_date, headers):
    ...
    filter_query = f"receivedDateTime ge {start_datetime} and receivedDateTime le {end_datetime}"
    ...
    try:
        while url:
            ...
            if len(all_emails) >= 5000:
                print("Warning: Reached 5000 emails limit. Consider narrowing your date range.")
                break
...
def retrieve_emails_by_date_range(start_date, end_date):
    print("============================================================")
...
def main():
    ...
    emails = retrieve_emails_by_date_range(start_date, end_date)
