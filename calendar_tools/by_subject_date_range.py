...
def get_access_token():
    ...
    print("============================================================")
    print("Calendar Subject Date Range Retriever - Authentication Required")
    print("============================================================")
    print(flow["message"])
    print("============================================================")
...
def search_meetings_by_subject_date_range(subject, start_date, end_date, headers):
    try:
...
def retrieve_meetings_by_subject_date_range(subject, start_date, end_date):
    print("============================================================")
    ...
    meetings = search_meetings_by_subject_date_range(subject, start_date, end_date, headers)
